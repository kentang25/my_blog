<div class="main-content">
    <section class="section">
      <div class="section-header">
        <h1>Template Temuan AMI</h1>
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="<?= base_url("admin") ?>">Dashboard</a></div>
          <div class="breadcrumb-item">Master</div>
          <div class="breadcrumb-item">Template Temuan AMI</div>
        </div>
      </div>

      <div class="section-body">
        <p class="section-lead">
          Template Temuanan AMI.
        </p>
    ...
    <form id="formAdd" >
      ...
      <div class="modal-body">
			...
			<div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder="Template Temuan" name="template_temuan" required>
			</div>
			</div>
        ...
        <div class="alert-body">
          ...
          <span class="err-edit"></span>
			...
			<div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder="Template Temuan" name="template_temuan">
			</div>
			</div>
      </div>
      <div class="modal-footer bg-whitesmoke br">
