    ...
    <section class="section">
      <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item">Tahap AMI</div>
        </div>
      </div>
    ...
    <form id="formAdd" >
      ...
      <div class="modal-body">
			...
			<div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder="Nama Tahap" name="nama_tahap" required>
			</div>
			</div>
			<div class="form-group">
        ...
        <div class="alert-body">
          ...
          <span class="err-edit"></span>
			...
			<div class="input-group">
			  ...
			  <input type="text" class="form-control" placeholder="Nama Tahap" name="nama_tahap">
			</div>
			</div>
			<div class="form-group">
			<label>Deskripsi</label>
...
<script>
    let url = "<?= base_url('admin/master/tahap/get_data');?>";
    var table = null;
    ...
    $(document).ready(function() {
        ...
        $('#formAdd').submit(function (e) {
          ...
          formData.push({ name: '<?= $this->security->get_csrf_token_name(); ?>', value: token });
            $.ajax({
                  url: "<?= base_url('admin/master/tahap/save')?>",
                  type: "POST",
                  dataType:'json',
                  data:formData,
        ...
        $('table').on('click', '#editData', function (e) {
          ...
          // console.log(row)
          $("#formEdit input[name=id_tahap]").val(row.id_tahap);
          $("#formEdit input[name=nama_tahap]").val(row.nama_tahap);
        ...
        $('#formEdit').submit(function (e) {
          ...
          formData.push({ name: '<?= $this->security->get_csrf_token_name(); ?>', value: token });
            $.ajax({
                  url: "<?= base_url('admin/master/tahap/update')?>",
                  type: "POST",
                  dataType:'json',
                  data:formData,
                  success: function(json){
        ...
        $('table').on('click', '#hapusData', function (e) {
          ...
          .then((willDelete) => {
            if (willDelete) {
              $.ajax({
                  url: "<?= base_url('admin/master/tahap/destroy')?>",
                  type: "POST",
                  dataType:'json',
        ...
        $("#massDelete").on("click",function(){
            ...
            .then((willDelete) => {
              if (willDelete) {
                $.ajax({
                    url: "<?= base_url('admin/master/tahap/mass_delete')?>",
                    type: "POST",
                    dataType:'json',
