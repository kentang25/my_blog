...
class Urperbaikan extends BackendController {
	//
    public $CI;
    public $table = "m_perbaikan";
	public $modul = "Urperbaikan";
	...
	public function index()
    {
        ...
        $this->template_admin('master/v_perbaikan', $this->data, true);
    }
    ...
    public function get_data()
    {
    	try {
	        ...
	        $query  = "SELECT * FROM m_perbaikan";
	        $search = array('template_perbaikan');
	        $where  = null; 
	        $isWhere = null;
    ...
    public function save(){
    	if($this->input->is_ajax_request()){
    		...
    		$this->form_validation->set_rules('template_perbaikan','Nama Temuan AMI','trim|required|min_length[3]');
			$this->form_validation->set_message('required','%s tidak boleh kosong !');

			if($this->form_validation->run() == TRUE){	
                $template_perbaikan  = clean_tag_input($this->input->post('template_perbaikan'));

                $data = array(
                    "template_perbaikan" => $template_perbaikan,
                );
				//insert 
