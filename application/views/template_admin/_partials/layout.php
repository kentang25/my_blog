    ...
    <nav class="navbar navbar-expand-lg main-navbar">
      <form class="form-inline mr-auto">
        ...
        <div class="form-group">
          <label class="badge badge-warning mr-2">Periode</label>
          <select class="form-control" required id="selectPeriode">
            <?php foreach (periodeAmi() as $key => $value): ?>
                <option <?php 
                if($this->session->userdata("periodeIDSet") == $value->id_periode)echo "selected";
              ?> value="<?= $value->id_periode  ?>"><?= $value->nama_periode ." - ". $value->tahun ?></option>
            <?php endforeach ?>
          </select>
        </div>
      ...
      <ul class="navbar-nav navbar-right">
       ...
       <!--  <li class="dropdown dropdown-list-toggle"><a href="#" data-toggle="dropdown" class="nav-link notification-toggle nav-link-lg beep"><i class="far fa-bell"></i></a>
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
          ...
          <div class="d-sm-none d-lg-inline-block">Assalamulaikum</div></a>
